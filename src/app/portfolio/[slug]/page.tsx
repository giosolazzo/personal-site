...
const ITEMS: Item[] = [
...

  {
    ...
    title: "[stealth] service marketplace ecosystem",
    headline: "[Stealth] Service Marketplace Ecosystem - One-Click Booking for Services",
    side: [
      "[Stealth] Service Marketplace Ecosystem",
      "Remote (US market)",
      "A pre-launch services platform concept for turning messy local services into clear, priced, bookable jobs",
      "------",
      "Market Research / Go-to-Market / Positioning",
      "September 2025 - December 2025",
    ],
    main: [
      "After the backpack chapter, I worked on a pre-launch service marketplace ecosystem for the US market.",
      "",
      "One-click booking, like Amazon but for services.",
      "",
      "The promise:",
      "- Know the price before booking",
      "- Know who is coming",
      "- Know when it is confirmed",
      "- Stop chasing five providers for one job",
      "",
      "The research:",
      "- 700 responses across the US",
      "- Quality-oriented 1-on-1 interviews",
      "- Nextdoor neighborhood supply and demand outreach",
      "- Prolific quantitative surveys",
      "- 81% would book and pay this week: yes or maybe",
      "- 68% would pay a premium for reliability",
      "- Real-time availability and quick booking became one of the clearest switch signals",
      "",
      "The product logic:",
      "- Upfront fixed pricing",
      "- Vetted local providers",
      "- Under-a-minute confirmation",
      "- One launch patch first: a few ZIP codes, enough providers, then demand",
      "- Provider-first, because demand breaks when supply is not ready",
      "- A daily-life layer: store value, reminders, and reasons to come back when it is time to invest in yourself",
      "",
      "The work:",
      "- Customer and provider scripts",
      "- Feature-priority testing",
      "- Landing page and waitlist thinking",
      "- Paid ad testing logic",
      "- Early local launch strategy",
      "",
      "Founder lesson:",
      "50/50 sounds simple.",
      "Working 50/50 is pressure, pace, trust, and ownership at the same time.",
      "After four months, the atmosphere was bad.",
      "Moving on was the cleanest decision.",
      "",
      "Still useful. It taught me how to turn messy early conversations into product direction.",
    ],
    image: "/images/portfolio/experiences/service-marketplace-ecosystem/logo.svg",
  },

  {
    slug: "behavera",
    title: "behavera",
    headline: "Behavera - Raw Sales, Growth, and the Human Layer",
    side: [
      "Behavera",
      "Prague, Czechia",
      "www.behavera.com",
      "AI people-analytics platform for behavioral assessment, employee pulse, engagement, burnout risk, and leadership signals",
      "------",
      "Partner / Growth",
    ...
    image: "/images/portfolio/experiences/behavera/logo.svg",
  },
];
...
const LINK_MAP: Record<string, string> = {
  ...
  "www.behavera.com": "https://www.behavera.com/",
  "behavera.com": "https://www.behavera.com/",
};
